...
the dataset used is uniib shar, trained on edge impulse, and deployed in the edge device (an arduino nano 33 ble sense) that is conncted to a laptop via usb.
