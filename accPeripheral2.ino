...
float filterAccelerometerReadings(float& x, float& y, float& z) {
  ...
  // Additional preprocessing steps can be added here based on your requirements
...
void loop() {
  ...
  if (central) {
    ...
    while (central.connected()) {
      ...
      // Apply filtering
      // filterAccelerometerReadings(xSensor, ySensor, zSensor);
      ...
      // float magnitude = calculateAccelerationMagnitude(xSensor, ySensor, zSensor);
    ...
    //      XChar.writeValue("Hello World!")'
      ...
      // Serial.print(FallDetect.canRead());
      // Serial.println();
