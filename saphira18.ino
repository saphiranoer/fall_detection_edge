    ...
    if (peripheral) {
        ...
        while (peripheral.connect()) {
            ...
            if (Xchar.canRead()) {
                ...
                // Serial.println(xFloat);  // Print the float value of x

                // Serial.println(String("Nilai Magnitude: ") + x);
                // Serial.print("Nilai Cl label count: ");
            ...
            if (count % 50 == 0) {
              ...
              Serial.print("fall adalah: ");
              Serial.print(fall);
              Serial.print(", adl adalah: ");
              Serial.print(adl);
              Serial.println();
